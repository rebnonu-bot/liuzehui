...
export default async function Loading({ params, searchParams }: LoadingProps) {
  const routeParams = params ? await params : { category: "" };
  ...
  return (
    <main className="pb-8 pt-2">
      ...
      <PaginationNav category={routeParams.category} page={page} pageTotal={page + 1} />
    </main>
  );
}
